...
default_cors = 'http://localhost:5173,http://localhost:3000,https://fulfilling-adventure-production-0c29.up.railway.app'
...
default_csrf = 'http://localhost:5173,https://fulfilling-adventure-production-0c29.up.railway.app,https://ai-voice-cloning-production.up.railway.app'
...
if not DEBUG:
    ...
    if not CORS_ALLOWED_ORIGINS:
         CORS_ALLOWED_ORIGINS = ["https://fulfilling-adventure-production-0c29.up.railway.app"]
    
    if not CSRF_TRUSTED_ORIGINS:
        CSRF_TRUSTED_ORIGINS = ["https://fulfilling-adventure-production-0c29.up.railway.app", "https://ai-voice-cloning-production.up.railway.app"]
